...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        sirens.add(new Siren(new Location(34.1367, -118.1253), SirenStatus.SAFE, true, "San Marino")); // Replaces repeat Pasadena
        sirens.add(new Siren(new Location(34.0000, -118.4695), SirenStatus.SAFE, true, "Playa del Rey")); // Replaces repeat Venice

        sirens.add(new Siren(new Location(33.9425, -118.4081), SirenStatus.SAFE, true, "LAX Airport"));
        sirens.add(new Siren(new Location(34.0520, -118.2439), SirenStatus.SAFE, false, "Downtown LA (South)"));
